...
To construct a data-driven error bound for the variation, $f_V$, in terms of the theoretical error bound in \eqref{eq:RKHSErrBd}, we must bound the norm of $f_V$ in terms of function data.  To do this we introduce a cone $\calc$ of candidate functions whose norms are approximated modestly well by the norms of their surrogates: 
...
\begin{equation} \label{eq:cos_sum}
	f_V(\bx) =  \cos( \alpha_1 x_1 + \cdots + \alpha_d x_d), \qquad \alpha_j = 2^{-\pi_d(j)}, j = 1, \ldots, d,
\end{equation}
...
Table  \ref{tab:cos_sum} is the output of applying a stripped-down version of our algorithm in Sect.\ \ref{sec:algo} without the trend. We take $\SVARERR(n,\mX,\by_{\VAR})$ to For $A(\mX)$ we use
...
\begin{array}{rcccccccccc} 
	\hline
	\text{Coordinate index}, j & 2 & 12 & 4 & 1 & 3 & 9 & 6 & \\
	\alpha_j & 0.5 & 0.25 & 0.13 & 0.063 & 0.031 & 0.016 & 0.0078\\
	\text{Final } \theta_j  & 0.41 & 0.18 & 0.094 & 0.061 & 0.038 & 0.020 & 0.012
\\ \hline
	\text{Coordinate index}, j & 5 & 10 & 8 & 7 & 11  \\
\alpha_j & 0.0039 & 0.0020 & 0.00098 & 0.00049 & 0.00024\\
\text{Final } \theta_j  & 0.0069 & 0.0037 & 0.0020 & 0.0031 & 0.00088 
\\ \hline
	n & 111 & 119 & 125 & 131 & 138 & 143 \\ \hline 
	\varepsilon & 5.0\text{E}{-}2 & 2.0\text{E}{-}2 & 1.0\text{E}{-}2 & 5.0\text{E}{-}3 & 2.0\text{E}{-}3 & 1.0\text{E}{-}3 \\ \hline 
	\ERR(n,\mX,\by) & 4.7\text{E}{-}2 & 1.7\text{E}{-}2 & 9.2\text{E}{-}3 & 4.6\text{E}{-}3 & 1.8\text{E}{-}3 & 9.7\text{E}{-}4 \\ \hline 
	\rule[3ex]{0pt}{0pt} \bignorm[\infty]{f - \APP(n,\mX,\by)} & 6.4\text{E}{-}3 & 3.4\text{E}{-}3 & 1.5\text{E}{-}3 & 6.1\text{E}{-}4 & 2.5\text{E}{-}4 & 1.4\text{E}{-}4 \\ \hline 
