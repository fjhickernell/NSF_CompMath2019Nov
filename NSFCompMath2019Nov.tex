...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The DWLS minimizes the residual $\sum w_i(f_i - f_{ls}(\bx_i))^2$, where the weights, $w_i(\bx)$ depend on the location where the function will be evaluated. In the Bayesian bootstrap method \cite{Rubin1981, Efron1982, Efron2016} we generate an ensemble of $B$ DWLS quasi-interpolants, $f_{ls}^b$, $b=1,B$ whee 
