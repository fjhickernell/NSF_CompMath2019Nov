...
Note that in $d$ dimensions, the number of basis functions, $K_p$,  for a polynomial of degree $K_d$ grows exponentially as $K_p={K_d + d \choose K_d} -1$ and  will far exceed the number of samples for even modest degree polynomials in high dimensions.   
